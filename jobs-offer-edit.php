...
<div class="content">
  ...
  <div class="card h-card h-p-30">
                      ...
                      <div class="card-sort-list clearfix">
                        ...
                        <div class="card-sort-list-item">
                          <div>
                            <figure class="card-upload-image">
                              <div class="thumb">
                                <img class="img-thumbnail" src="image/img04.jpg" alt="Another alt text">
                                <div class="card-overlay">  
                                  <div class="card-overlay-inner">
                                    <ul class="card-inline-list">
                                      <li class="card-inline-item">
                       ...
                       <div class="card-sort-list-item">
                          <div>
                            <figure class="card-upload-image">
                              <div class="thumb">
                                <img class="img-thumbnail" src="image/img06.jpg" alt="Another alt text">
                                <div class="card-overlay">  
                                  <div class="card-overlay-inner">
                                    <ul class="card-inline-list">
                                      <li class="card-inline-item">
                        ...
                        <div class="card-sort-list-item">
                          <div>
                            <figure class="card-upload-image">
                              <div class="thumb">
                                <img class="img-thumbnail" src="image/img07.jpg" alt="Another alt text">
                                <div class="card-overlay">  
                                  <div class="card-overlay-inner">
                                    <ul class="card-inline-list">
                                      <li class="card-inline-item">
                       ...
                       <div class="card-sort-list-item">
                          <div>
                            <figure class="card-upload-image">
                              <div class="thumb">
                                <img class="img-thumbnail" src="image/img08.jpg" alt="Another alt text">
                                <div class="card-overlay">  
                                  <div class="card-overlay-inner">
                                    <ul class="card-inline-list">
                                      <li class="card-inline-item">
                ...
                <dd class="definition-table-body e-fac-new-left card-font-grey">
                  <div class="space-pd-btm-sm">
                    <div class="card-small-short space-pd-btm-sm">
                      ...
                      <span class="definition-txt-alert card-fw-normal">※他サイトからの引用・転載およびジョブメドレーに掲載する文章・写真の無断転載は固く禁止します。</span>
                    </div>
            ...
            <li class="definition-table-item ">
              <dl class="dl-definition-table">
                ...
                <dd class="definition-table-body e-fac-new-left">
                  ...
                  <div class="space-pd-btm-sm">
                      <textarea name="preferred" class="card-textarea e-card-textarea space-mt-10" placeholder="[1] ジョブメドレーの応募フォームよりご応募ください ↓[2] 採用担当より面接日程の調整などの連絡をさせていただきます ↓[3] 面接実施 ↓[4] 採用決定のご連絡 ↓[5] 入職手続きを進めつつ、ジョブメドレーから祝い金をご申請ください ※応募から内定までは平均1週間～1ヶ月ほどになります。※在職中で今すぐ転職が難しい方も調整のご相談が可能です。" maxlength="2000" rows="1" style="overflow: hidden; overflow-wrap: break-word; height: 76px;"></textarea>
                  </div>
                </dd>
                <dd class="e-fac-new-right">
      ...
      <p class="card-font-grey">採用単価とは、採用後にジョブメドレーよりご請求させていただく金額です。この情報は求職者へは開示されません。</p>
      <div class="space"></div>
      <form method="POST" >
          <ul class="definition-table">
            <li class="definition-table-item">
