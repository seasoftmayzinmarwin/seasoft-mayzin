<div class="modal fade" id="searchicon-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="c-m-page-header__title">
                  <h1 class="c-m-heading m-fw-bold">採用単価表変更のお知らせ</h1>
              ...
              <div class="c-m-box">
                <form action="" method="" accept-charset="utf-8">
                  <div class="m-pd-top">
                    ...
                    <h1 class="c-m-heading c-m-heading--l">希望職種/経験年数</h1>
                  </div>
                    <div class="ds-o-flex-item m-pd-top">
                      <div class="card-option">
                        <label class="card-selectbox">
                          <select name="job_category_id" id="customer_message_template" class="card-selectbox-select">
                            ...
                            <optgroup label="医科">
                              ...
                              <option value="13">診療放射線技師</option>
                              <option value="8">臨床検査技師</option>
                              <option value="24">臨床工学技士</option><option value="28">管理栄養士/栄養士</option>
                              <option value="14">公認心理師/臨床心理士</option>
                              <option value="31">医療ソーシャルワーカー</option>
                              <option value="35">登録販売者</option>
                  ...
                  <div class="m-pd-top">
                    <div class="ds-o-flex__item">
                    <h1 class="c-m-heading c-m-heading--l">エリア</h1>
                  </div>
                     <div class="ds-o-flex-item m-pd-top">
                      <div class="card-option">
                        <label class="card-selectbox">
                  ...
                  <div class="m-pd-top">
                    <div class="ds-o-flex__item">
                    <a href="#" class="c-m-text-link">市区町村を指定</a>
                  </div>
                     <div class="ds-o-flex-item m-pd-top">
                      <div class="card-option">
                        <label class="card-selectbox">
                    ...
                    <div class="ds-o-flex-item">
                      <div class="row">
                        <div class="col">
                          <a href="#" class="c-m-text-link c-m-text-link--disabled">市区町村を指定</a>
                        </div>
                        <div class="col">
                          <a href="#" class="c-m-text-link c-m-text-link--red pull-right">条件を削除</a>
                        </div>
                      </div>
                    </div>
                    <div class="m-space-md"></div>
