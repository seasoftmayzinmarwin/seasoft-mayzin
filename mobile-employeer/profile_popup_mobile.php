<div class="modal fade" id="profile-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div class="c-m-page-header__title">
                  <h1 class="c-m-heading m-fw-bold">求職者検索<a href="" class="m-question" title=""><i class="fa fa-question-circle-o" aria-hidden="true"></i></a> </h1>
                  ...
                  <div class="card-msg-box">
                    <div class="card-msg-body-inner">
                      <div class="card-msg-view-body">
                        ...
                        <span> 
                          <span class="card-fw-normal">この度は、ジョブメドレーの求人広告を見て応募いたしました。<br></span>
