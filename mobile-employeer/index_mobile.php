						...
						<li class="c-m-bordered-list__item">
							...
							<div class="">
								...
								<div class="m-menu-item">
									<a href="searches_mobile.php" title="" class="c-m-box-link text-center">
										<div>
								...
								<div class="m-menu-item">
									<a href="message_mobile.php" title="" class="c-m-box-link text-center">
										<div>
											<div><i class="fa fa-commenting-o fa-2x" aria-hidden="true"></i></div>
											<h3 class="c-m-heading c-m-heading--l m-pd-top">メッセージ</h3>
										</div>
									</a>
								</div>
								<div class="m-menu-item">
									<a href="" title="" class="c-m-box-link text-center">
										<div>
											<div><i class="fa fa-bell-o fa-2x" aria-hidden="true"></i></div>
					...
					<div class="row">
						<div class="col">							
							<ul class="m-scrollable-list__inner">
								<li class="m-scrollable-list__item">
										...
										<div class="m-member-card__body">
											<div class="m-panel m-panel--border m-panel--grey">
												<div class="c-m-box c-m-box--horizontal-m">
													<ul class="c-m-bordered-list">
														<li class="c-m-bordered-list__item">
															<div class="c-m-box m-pd-sm"><h1 class="c-m-heading c-m-heading--xl">24歳&nbsp;男性&emsp;神奈川県横浜市戸塚区</h1></div>
																		...
																		<div class="panel-heading">
																			<dl class="m-collapse-table">
																				<div class="row m-pd-top">
																						...
																						<dd class="col m-fs-sm"><span>看護師/准看護師</span></dd>
																				</div>
																				<div class="row">
																						<dt class="col-4 m-fw-bold m-fs-sm">希望職種</dt>
																						<dd class="col m-fs-sm"><span>保育補助 (2年未満)</span></dd>
																						<dd class="col-1">
