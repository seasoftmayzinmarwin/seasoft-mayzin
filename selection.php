                ...
                <tr class="card-tbl-row">
                  ...
                  <td class="card-tbl-body-item">
                    ...
                    <div class="card-item-title">入職予定日
                      ...
                      <button data-toggle="modal" data-target="#squarespaceModal" type="button" class="blue-btn card-btn-sm card-wd-100 card-fw-bold">スカウトを送る</button><br>
                    </td>
                </tr>
              </tbody><!-- .card-tbl-body -->
            </table><!-- .card-tbl -->
          ...
          <div class="modal-dialog card-mx-900 modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="card-fw-bold" id="image-gallery-title">入職状況の変更</h4>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span>
                </button>
              </div>
              <div class="modal-body">
                <div class="card-wd-490 space-mt-auto">
                  <div class="card-flex card-flex-col ">
                    <div class="card-flex-item">
                      <ul class="card-field-group">
                        <li class="card-field-group-item">
                          <label for="" class="card-radio-button">
                          <input type="radio" value="1" name="selection_status" class="card-radio-input">
                          <div class="card-radio-inner"><span class="card-radio-icon-box">
                            <span class="SVGInline SVGInline--cleaned c-icon c-icon--white"></span>
                            </span>
                            <span class="card-radio-text">応募済</span>
                            <span class="card-radio-info"></span>
                            </div>
                          </label>
                        </li>
                        <li class="card-field-group-item">
                        ...
                        </li><li class="card-field-group-item">
                          <label for="" class="card-radio-button">
                          <input type="radio" value="1" name="selection_status" class="card-radio-input">
                          <div class="card-radio-inner"><span class="card-radio-icon-box">
                            <span class="SVGInline SVGInline--cleaned c-icon c-icon--white"></span>
                        ...
                        <li class="card-field-group-item">
                          ...
                          <div class="card-radio-inner"><span class="card-radio-icon-box">
                            ...
                            <span class="card-radio-text">応募済</span>
                            <span class="card-radio-info">決定後は日程など早めのご入力をお願いいたします</span>
                            </div>
                          </label>
                        </li>
                      </ul>
                    </div><!-- .card-flex-item -->
                    <div class="card-flex-item space-pd-top-md">
                      <ul class="card-field-group">
                        <li class="card-field-group-item">
                          <label for="" class="card-radio-button">
                          <input type="radio" value="1" name="selection_status" class="card-radio-input">
